...
import { get_all_users, get_user_by_eNumber, get_user_by_id, delete_user, create_user, update_password, verifyStudentPassword, verifyTeacherPassword, verifyAdminPassword, get_all_students, get_all_teachers, get_user_by_eNumber_backend } from "./functions/user_functions";
  ...
  GET: async () => {
    ...
    return new Response("Logged out", {
      ...
      "/api/teacher/:id":{
        // Get user by eNumber
        GET: async req => {
          const data = await get_user_by_id(db, req);
          return Response.json(data);
       }
      },
